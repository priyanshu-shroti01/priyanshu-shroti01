...
Adapted from github.com/gargibhardwaj24/gargibhardwaj24.

    python scripts/cards.py --user priyanshu-shroti01 --out assets
...
THEMES = {
    "dark": {
        "bg": "#0d1117", "border": "#30363d", "title": "#00C7B7",
        "text": "#c9d1d9", "muted": "#8b949e", "value": "#e6edf3",
        "accent": "#00C7B7",
    },
    "light": {
        "bg": "#ffffff", "border": "#d0d7de", "title": "#0f766e",
